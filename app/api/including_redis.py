...
def set_cache(key: str, id: str, data, timer: int = 600):
...
def set_item_cache_to_redis(key: str, id: str, data, timer: int = 600):
...
def set_list_cache_to_redis(key: str, id: str, data, timer: int = 600):
    bestiaries_dicts = [
